    ...
    <main style={{ background: '#F8F4EE', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ background: '#fff', border: '1px solid rgba(30,58,47,0.11)', borderRadius: '16px', padding: '40px', width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#8A8A82' }}>Sign in to your account</p>
        </div>
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          style={{ width: '100%', background: '#1E3A2F', color: '#F8F4EE', border: 'none', padding: '12px', borderRadius: '10px', fontSize: '14px', fontWeight: 500, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" }}
        >
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: '#8A8A82', marginTop: '20px' }}>
          ...
          <a href="/signup" style={{ color: '#1E3A2F', fontWeight: 500 }}>Sign up</a>
        </p>
      </div>
    </main>
  )
