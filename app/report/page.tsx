...
export default function ReportCard() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif" }}>
      <p style={{ color: '#8A8A82' }}>Loading report card...</p>
    </div>
  )
      ...
      <div ref={reportRef} style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 28px 64px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '20px 0', borderTop: '1px solid rgba(30,58,47,0.08)' }}>
          ...
          <p style={{ fontSize: '12px', color: '#8A8A82' }}>
            Generated by Hearth · {window.location.host} · {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
          </p>
        </div>
      </div>
    </main>
